...
@section('content')
    <div class="container">
        <section class="hero animate-fade-in">
            ...
            <p>Explore thousands of titles from fiction to technology. Get ready to embark on a new journey with every page.</p>
            <a href="#books" class="nav-btn">Browse Collection</a>
        </section>
