...
<div class="table-card" style="max-width: 700px;">
    <form action="{{ route('admin.coupons.store') }}" method="POST">
        ...
        <div style="margin-bottom: 1.25rem;">
            ...
            <input type="text" name="ma_code" value="{{ old('ma_code') }}" placeholder="VD: SALE2026" required
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.25rem; margin-bottom: 1.25rem;">
            <div>
                ...
                <input type="number" name="so_tien_giam" value="{{ old('so_tien_giam') }}" placeholder="VD: 50000" min="0" step="1000"
            ...
            <div>
                ...
                <input type="number" name="phan_tram_giam" value="{{ old('phan_tram_giam') }}" placeholder="VD: 20" min="0" max="100"
                    style="width: 100%; padding: 0.75rem 1rem; border: 1.5px solid #e2e8f0; border-radius: 0.65rem; font-size: 0.95rem; outline: none; transition: 0.2s; box-sizing: border-box;"
                    onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#e2e8f0'">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.25rem; margin-bottom: 1.5rem;">
            <div>
                ...
                <input type="number" name="so_luong" value="{{ old('so_luong', 100) }}" required min="0"
                    style="width: 100%; padding: 0.75rem 1rem; border: 1.5px solid #e2e8f0; border-radius: 0.65rem; font-size: 0.95rem; outline: none; transition: 0.2s; box-sizing: border-box;"
                    onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#e2e8f0'">
            ...
            <div>
                ...
                <input type="date" name="ngay_het_han" value="{{ old('ngay_het_han') }}"
                    style="width: 100%; padding: 0.75rem 1rem; border: 1.5px solid #e2e8f0; border-radius: 0.65rem; font-size: 0.95rem; outline: none; transition: 0.2s; box-sizing: border-box;"
                    onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#e2e8f0'">
        ...
        <div style="display: flex; gap: 1rem;">
            <button type="submit" style="background: var(--primary); color: white; padding: 0.75rem 2rem; border: none; border-radius: 0.65rem; font-weight: 700; font-size: 0.95rem; cursor: pointer; transition: 0.2s;"
                onmouseover="this.style.opacity='0.9'" onmouseout="this.style.opacity='1'">Tạo mã giảm giá</button>
