...
<div class="container" style="padding-top: 4rem; padding-bottom: 4rem;">
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 4rem; margin-bottom: 4rem;">
        ...
        <div>
            ...
            <p style="font-size: 1.25rem; color: var(--text-secondary); margin-bottom: 2rem;">by {{ $book->tac_gia }}</p>

            <div style="font-size: 2rem; font-weight: 700; color: var(--text-primary); margin-bottom: 2rem;">
                ${{ number_format($book->gia, 2) }}
            </div>
            ...
            <div style="display: flex; gap: 1rem; margin-bottom: 3rem;">
                ...
                <button class="nav-btn" style="flex: 1;">Add to Cart</button>
            </div>

            <div style="padding-top: 2rem; border-top: 1px solid var(--border-color);">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    <div>
                        <span style="color: var(--text-secondary); display: block; font-size: 0.875rem;">Category</span>
                        <span style="font-weight: 600;">Fiction</span>
                    </div>
                     <div>
                        <span style="color: var(--text-secondary); display: block; font-size: 0.875rem;">Stock</span>
                        <span style="font-weight: 600;">{{ $book->so_luong > 0 ? 'In Stock' : 'Out of Stock' }}</span>
                    </div>
                </div>
            </div>
        </div>
